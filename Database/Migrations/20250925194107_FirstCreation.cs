        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "(Price * 1.2)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmentManager_SuperUsers_ManagersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Orders_PK_Id", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_SuperUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Id_LineNumber", x => new { x.OrderId, x.LineNumber });
                    table.ForeignKey(
